...
const SlugVideos = () => {
    ...
    // console.log(NLdata)
    return (
        <div className="grid grid-cols-1 pt-[4vh] md:pb-[1vh] md:grid-cols-3 lg:grid-cols-4 md:ml-[3vw] lg:h-[84vh] gap-4">
            {SlicedData.map((data) => {   
                ...
                return(
                    <div className="skeleton" key={data.vId} onClick={()=>PostVidClick(data)}>
